...
4. ~~Mobile Jest rendering test: npm repeatedly extracted incomplete third-party package contents in this workspace...~~ **Resolved and verified**: the full mobile-client Jest suite now runs cleanly (124 tests passing, 14 suites), and both TypeScript and ESLint checks are clean. See `README.md` §6 for the current count.
