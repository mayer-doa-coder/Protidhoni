...
const styles = StyleSheet.create({
  ...
  categoryChip: {borderWidth: 2, borderRadius: radius.pill, paddingHorizontal: 12, paddingVertical: 6},
  categoryChipText: {color: colors.ink, fontWeight: '600'},
  ...
  cancelButton: {flex: 1, borderRadius: radius.sm, padding: 12, alignItems: 'center', backgroundColor: colors.background},
  cancelButtonText: {color: colors.ink, fontWeight: '700'},
  saveButton: {flex: 1, borderRadius: radius.sm, padding: 12, alignItems: 'center', backgroundColor: colors.primary},
